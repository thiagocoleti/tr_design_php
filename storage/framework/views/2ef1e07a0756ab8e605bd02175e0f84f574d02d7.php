    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto active" href="<?php echo e(route ('route_form')); ?>">NOVO PROJETO</a></li>
          <li><a class="nav-link scrollto" href="#contact">TR-MODEL</a></li>
          <li><a class="getstarted scrollto" href="<?php echo e(route ('route_inicio')); ?>">SAIR</a></li>
        </ul>
...
</html><?php /**PATH C:\Users\acer\Desktop\projetolaravel\resources\views/form.blade.php ENDPATH**/ ?>