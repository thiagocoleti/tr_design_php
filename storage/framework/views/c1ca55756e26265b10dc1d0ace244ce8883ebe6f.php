    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto active" href="<?php echo e(route ('route_inicio')); ?>">INÍCIO</a></li>
          <li><a class="nav-link scrollto" href="#contact">MEUS PROJETOS</a></li>
          <li><a class="nav-link scrollto" href="<?php echo e(route ('route_form')); ?>">NOVO PROJETO</a></li>
          <li><a class="nav-link scrollto" href="#contact">TR-MODEL</a></li>
          <li><a class="getstarted scrollto" href="<?php echo e(route ('route_login')); ?>">ACESSAR</a></li>
        </ul>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="<?php echo e(route ('route_cadastro')); ?>">CADASTRAR</a></h4>
          ...
          <div class="col-lg-4 col-md-6 mt-4 mt-md-0">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="<?php echo e(route ('route_login')); ?>">ACESSAR</a></h4>
...
</html><?php /**PATH C:\Users\acer\Desktop\projetolaravel\resources\views/index.blade.php ENDPATH**/ ?>